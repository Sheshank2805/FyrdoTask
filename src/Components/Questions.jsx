...
<div><h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4">Frequently Asked Questions</h1></div>
  ...
  <div id="accordion-color-body-1"  aria-labelledby="accordion-color-heading-1">
    <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
      <p className="mb-2 text-gray-500 dark:text-gray-400"> Greet is a subsidiary of Fydo (Lfyd Services Pvt Ltd), an event booking platform designed to streamline the process of organizing and attending events. It offers a user-friendly interface for event organizers and attendees.</p>
  </div>
