...
const Metrics = () => {
  return (
    <div className="flex flex-col w-full sm:w-full md:w-[720px] lg:w-[960px] xl:w-[1440px] items-center gap-4 sm:gap-6 md:gap-8 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20 relative bg-[#0b0d17]">
      ...
      <div className="flex flex-col sm:flex-row w-full sm:w-full md:w-[720px] lg:w-[960px] xl:w-[1170px] items-start gap-4 sm:gap-6 md:gap-8 relative">
        <MetricItem
